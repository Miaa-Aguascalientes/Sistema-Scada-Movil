...
# 3. Renderizado de KPIs (Organizado y sin errores)
    # Fila 1: 3 elementos (aprovecha mejor el ancho)
    f1 = st.columns(3)
    ...
    # Fila 2: 2 elementos (dinámico y sumergencia)
    f2 = st.columns(2)
